...
namespace StudentReviewManager.Migrations
{
    ...
    [Migration("20240616230022_changed_nickname_field")]
    partial class changed_nickname_field
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentReviewManager.DAL.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentReviewManager.DAL.Models.Course", b =>
                {
                    b.HasOne("StudentReviewManager.DAL.Models.Degree", "Degree")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("StudentReviewManager.DAL.Models.School", b =>
                {
                    b.HasOne("StudentReviewManager.DAL.Models.City", "City")
                        .WithMany("Schools")
            ...
            modelBuilder.Entity("StudentReviewManager.DAL.Models.User", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("StudentReviewManager.DAL.Models.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
